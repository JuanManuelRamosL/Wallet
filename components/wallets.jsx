  ...
  return (
    <div className="container-wallet">
      ...
      <div className="container-name-image-wallet">
        {/* <p className="name-wallet">{data3.binance?.name}</p> */}
        {/* <img src={data3.binance?.logo} alt="Imagen de Wallet" className="img-wallet" /> */}
        <svg
      ...
      <div className="container-description-wallets">
        ...
        <WalletSection
          className="container-izq"
          title="Tarifas"
          text="Binance es conocida por sus bajas tarifas. Cobra un 0.10% por
